...
struct SeasonDetailsRequest: APIRequest {
    ...
    func parseResponse(data: Data) throws -> SeasonDetailsReponse {
        return try JSONDecoder().decode(SeasonDetailsReponse.self, from: data)
    }
}
